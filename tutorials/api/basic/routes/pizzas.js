...
// le ? c'est pour passer le null
// le ?? si valeur a gauche null, on met celle de droite
router.get('/', (req, res, next) => {
  const orderByTitle =
    req?.query?.order?.includes('title') ? req.query.order : undefined; // le ? vuet dire si null
     // le ? au milieu est unoperateur ternaire. si le partie gauche est false ou null ça renvoie undefined
  // si true  ça renvoie req.query.order
  let orderedMenu;
...
router.post('/', (req, res) => {
  ...
  // le ? au milieu est unoperateur ternaire. si le partie gauche est false ou null ça renvoie undefined
  // si true  ça renvoie req.body.title
